...
# File: wr_sdram_git.tcl
# Generated on: Sat Mar 12 12:14:52 2016
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "wr_sdram_git"]} {
		puts "Project wr_sdram_git is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists wr_sdram_git]} {
		project_open -revision wr_sdram_git wr_sdram_git
	} else {
		project_new -revision wr_sdram_git wr_sdram_git
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name PROJECT_CREATION_TIME_DATE "19:38:50  FEBRUARY 27, 2016"
	...
	set_global_assignment -name VERILOG_FILE send_i2c.v
	set_global_assignment -name VERILOG_FILE camera_cfg.v
	set_global_assignment -name VERILOG_FILE vga_module.v
	set_global_assignment -name VERILOG_FILE vga_control_module.v
	set_global_assignment -name VERILOG_FILE test_top.v
	set_global_assignment -name VERILOG_FILE sync_module.v
	set_global_assignment -name VERILOG_FILE smg_encoder_module.v
	set_global_assignment -name VERILOG_FILE sdram_wrdata.v
	set_global_assignment -name VERILOG_FILE sdram_top.v
	set_global_assignment -name VERILOG_FILE sdram_param.v
	set_global_assignment -name VERILOG_FILE sdram_para.v
	set_global_assignment -name VERILOG_FILE sdram_ctrl.v
	set_global_assignment -name VERILOG_FILE sdram_cmd.v
	set_global_assignment -name VERILOG_FILE row_scan_module.v
	set_global_assignment -name VERILOG_FILE rom2fifo.v
	set_global_assignment -name VERILOG_FILE reset_gen.v
	set_global_assignment -name VERILOG_FILE read_rom.v
	set_global_assignment -name VERILOG_FILE ps2.v
	set_global_assignment -name VERILOG_FILE pll_module.v
	set_global_assignment -name VERILOG_FILE pll_133.v
	set_global_assignment -name VERILOG_FILE pika_rom2.v
	set_global_assignment -name VERILOG_FILE number_mod_module.v
	set_global_assignment -name VERILOG_FILE fifo2vga.v
	set_global_assignment -name VERILOG_FILE digitron.v
	set_global_assignment -name VERILOG_FILE desk_fifo.v
	set_global_assignment -name VERILOG_FILE desk.v
	set_global_assignment -name VERILOG_FILE clk_100m.v
	set_global_assignment -name SDC_FILE wr_sdram_git.sdc
	...
	set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to Blue_Sig[4]
